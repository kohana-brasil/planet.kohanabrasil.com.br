...
if (isset($_REQUEST['url'])) {
    ...
    $tests = array(
        ...
        'opml' => array(
            'label'=>'OPML file <code>./custom/people.opml</code> is writable',
            'solution' => 'Change the access rights for <code>./custom/people.opml</code> with CHMOD'
        ),
        'config' => array(
            'label'=>'Configuration file <code>./custom/config.yml</code> is writable',
        ...
        'changepassword' => array(
            ...
            'solution' => 'Change the access right for <code>./admin/inc/auth.inc.php</code> with CHMOD'
        ),
        'cache' => array(
            'label'=>'Cache directory <code>./cache</code> is writable',
